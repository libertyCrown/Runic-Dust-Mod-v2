 ...
 */
public class RuneForcefield extends PoweredEvent
{
	public RuneForcefield()
	{
		super();
	}
	...
	public void onInit(EntityDust e)
	{
		...
		ItemStack[] req = new ItemStack[] { new ItemStack(Item.monsterPlacer,
				1, 120 /* testificate */) };
		req = this.sacrifice(e, req);
		if (!checkSacrifice(req) || a != b || b != c || c != d
				|| !takeXP(e, 15))
		{
			e.fizzle();
			return;
	...
	public void onTick(EntityDust e)
	{
		...
		for (Entity i : ents)
		{
			...
			// if(i instanceof EntityItem && !i.isDead &&
			// i.getDistanceToEntity(e) <= 1.4D){
