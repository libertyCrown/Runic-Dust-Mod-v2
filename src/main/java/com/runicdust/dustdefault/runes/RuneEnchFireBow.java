 ...
 */
public class RuneEnchFireBow extends DustEvent
{
	public RuneEnchFireBow()
	{
		super();
	}
	...
	public void onInit(EntityDust e)
	{
		...
		// ItemStack is = i.item;
		//
		// if(is.itemID == Item.pickaxeDiamond.itemID || is.itemID ==
		// Item.shovelDiamond.itemID) {
		// item = is.itemID;
		// break;
		// }
		// }
		// int gold = ((item == Item.pickaxeDiamond.itemID) ?
		// Item.pickaxeGold.itemID:Item.shovelGold.itemID);
		ItemStack[] req = this.sacrifice(e, new ItemStack[] {
				new ItemStack(Item.bow, 1, 0),
				new ItemStack(Block.blockGold.blockID, 1, 0),
				new ItemStack(Item.fireballCharge, 9) });
