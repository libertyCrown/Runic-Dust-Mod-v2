 ...
 */
public class RuneTorch extends DustEvent
{
	public RuneTorch()
	{
		super();
	...
	{
		int[][] ref = new int[][] { { 25, 21, 21 }, { 151, 52, 49 },
				{ 53, 71, 28 }, { 80, 51, 31 }, { 47, 57, 142 },
				{ 126, 61, 181 }, { 46, 110, 136 }, { 155, 161, 161 },
				{ 64, 64, 64 }, { 208, 132, 153 }, { 66, 175, 57 },
				{ 178, 167, 40 }, { 106, 137, 200 }, { 180, 80, 189 },
				{ 219, 124, 61 }, { 255, 255, 255 }, };
		return ref[meta];
	}
