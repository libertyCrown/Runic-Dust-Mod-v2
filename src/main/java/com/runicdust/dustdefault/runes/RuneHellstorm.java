 ...
 */
public class RuneHellstorm extends PoweredEvent
{
	public RuneHellstorm()
	{
		super();
	}
	...
	public void onTick(EntityDust e)
	{
		...
		{
			EntityArrow ea = new EntityArrow(e.worldObj, e.posX + Math.random()
					* rad * 2 - rad, 158, e.posZ + Math.random() * rad * 2
					- rad);
			ea.motionX = 0;
			ea.motionY = -2D;
			ea.motionZ = 0;
