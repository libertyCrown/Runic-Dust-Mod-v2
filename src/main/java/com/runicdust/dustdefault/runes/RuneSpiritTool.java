 ...
 */
public class RuneSpiritTool extends DustEvent
{
	...
	{
		// int compare = mod_DustMod.compareDust(mod_DustMod.lapisDID,
		// e.dustID);
		// if(compare < 0){
		// e.fizzle();
		// return;
		...
		// int meatamt = 8;
		//
		// int[] meats = new int[]{Item.porkCooked.itemID, Item.porkRaw.itemID,
		// Item.beefCooked.itemID, Item.beefRaw.itemID,
		// Item.chickenCooked.itemID, Item.chickenRaw.itemID,
		// Item.rottenFlesh.itemID, Item.fishCooked.itemID,
		// Item.fishRaw.itemID};
		...
		if (!checkSacrifice(req))
		{
			...
			req = new ItemStack[] { new ItemStack(Item.swordGold, 1),
	...
	// }
	//
	// public static HashMap<ItemStack,ItemStack> entdrops = new
	// HashMap<ItemStack,ItemStack>();

	// static{
	// entdrops.put(new ItemStack(Item.pickaxeStone, 0, -1), new
	// ItemStack(mod_DustMod.spiritPickaxe.itemID, 1, 0));
	// entdrops.put(new ItemStack(Item.swordStone, 0, -1), new
	// ItemStack(mod_DustMod.spiritSword.itemID, 1, 0));
	// }
}