package com.runicdust.dustcore.client.model;
...
public class ModelDustBook extends ModelBase
{
	...
	{
		rightCover = (new ModelRenderer(this)).setTextureOffset(0, 0)
				.addBox(-6F, -5F, 0.0F, 6, 10, 0).setTextureSize(140, 74);
		leftCover = (new ModelRenderer(this)).setTextureOffset(16, 0)
				.addBox(0.0F, -5F, 0.0F, 6, 10, 0).setTextureSize(140, 74);
		spineCover = (new ModelRenderer(this)).setTextureOffset(12, 0)
				.addBox(-1F, -5F, 0.0F, 2, 10, 0).setTextureSize(140, 74);
		rightPageThick = (new ModelRenderer(this)).setTextureOffset(0, 10)
				.addBox(0.0F, -4F, -0.99F, 5, 8, 1).setTextureSize(140, 74);
		leftPageThick = (new ModelRenderer(this)).setTextureOffset(12, 10)
				.addBox(0.0F, -4F, -0.01F, 5, 8, 1).setTextureSize(140, 74);
		stand = (new ModelRenderer(this)).setTextureOffset(32, 0)
				.addBox(-6.0F, -4F, -3F, 12, 10, 1).setTextureSize(140, 74);
		standBack = (new ModelRenderer(this)).setTextureOffset(32, 16)
				.addBox(-3.0F, -1F, -7F, 6, 3, 4).setTextureSize(140, 74);
		// standBack = (new ModelRenderer(this)).setTextureOffset(32,
		// 0).addBox(0.0F, -4F, 2F, 5, 8, 1).setTextureSize(140, 74);
		textureWidth = 70;
		textureHeight = 56;
		rightFlippyPage = (new ModelRenderer(this)).setTextureOffset(35, 0)
				.addBox(0.0F, -25.5F, 0.0F, 35, 56, 0).setTextureSize(140, 56);
		leftFlippyPage = (new ModelRenderer(this)).setTextureOffset(35, 0)
				.addBox(0.0F, -25.5F, 0.0F, 35, 56, 0).setTextureSize(140, 56);
	...
	public void renderPages(Entity entity, float f, float f1, float f2,
