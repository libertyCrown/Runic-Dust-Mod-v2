 ...
 * using the {@link org.xml.sax.XMLReader#setErrorHandler setErrorHandler}
 ...
 * <em>SAXParseException</em>s will be thrown for fatal errors. In order to
 ...
 * errors after a call to {@link #fatalError fatalError}. In other words, a SAX
 * driver class may throw an exception after reporting any fatalError. Also
 * parsers may throw appropriate exceptions for non-XML errors. For example,
 * {@link XMLReader#parse XMLReader.parse()} would throw an IOException for
