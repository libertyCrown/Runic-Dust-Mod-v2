 ...
 * filters, by passing on all {@link org.xml.sax.EntityResolver EntityResolver},
 * {@link org.xml.sax.DTDHandler DTDHandler}, {@link org.xml.sax.ContentHandler
 * ContentHandler} and {@link org.xml.sax.ErrorHandler ErrorHandler} events
 * automatically.
 * </p>
 * 
 * @since SAX 2.0
...
public interface XMLFilter extends XMLReader
{
	 ...
	 * 
	 * <p>
	 * This method allows the application to link the filter to a parent reader
	 * (which may be another filter). The argument may not be null.
	 * </p>
	 * 
	 * @param parent
	 *            The parent reader.
	 ...
	 * 
	 * <p>
	 * This method allows the application to query the parent reader (which may
	 * be another filter). It is generally a bad idea to perform any operations
	 * on the parent reader directly: they should all pass through this filter.
	 * </p>
	 * 
