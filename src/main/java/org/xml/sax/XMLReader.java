 ...
 * 
 * <p>
 * <strong>Note:</strong> despite its name, this interface does <em>not</em>
 * extend the standard Java {@link java.io.Reader Reader} interface, because
 * reading XML is a fundamentally different activity than reading character
 * data.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * All SAX interfaces are assumed to be synchronous: the {@link #parse parse}
 * methods must not return until parsing is complete, and readers must wait for
 * an event-handler callback to return before reporting the next event.
 * </p>
 * 
 * <p>
 * This interface replaces the (now deprecated) SAX 1.0
 * {@link org.xml.sax.Parser Parser} interface. The XMLReader interface contains
 * two important enhancements over the old Parser interface (as well as some
 * minor ones):
 * </p>
 * 
 * <ol>
 * <li>it adds a standard way to query and set features and properties; and</li>
 * <li>it adds Namespace support, which is required for many higher-level XML
 * standards.</li>
 * </ol>
 * 
 * <p>
