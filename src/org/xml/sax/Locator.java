 ...
 * {@link org.xml.sax.ContentHandler#setDocumentLocator setDocumentLocator}
 * method. The application can use the object to obtain the location of any
 ...
 * the application receives the {@link org.xml.sax.ContentHandler#startDocument
 * startDocument} event, the application should assume that a locator is not
 * available.
 * </p>
 * 
 * @since SAX 1.0
...
public interface Locator
{
	 ...
	 * original XML document. In some cases, these "line" numbers match what
	 * would be displayed as columns, and in others they may not match the
	 ...
	 * one-based number of Java <code>char</code> values since the last line
	 * end.
	 * 
	 * <p>
	 * <strong>Warning:</strong> The return value from the method is intended
	 * only as an approximation for the sake of diagnostics; it is not intended
	 * to provide sufficient information to edit the character content of the
	 * original XML document. For example, when lines contain combining
	 * character sequences, wide characters, surrogate pairs, or bi-directional
	 * text, the value may not correspond to the column in a text editor's
	 * display.
	 * </p>
	 * 
	 * <p>
