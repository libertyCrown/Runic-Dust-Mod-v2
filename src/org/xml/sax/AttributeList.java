 ...
 * Unlike the new {@link org.xml.sax.Attributes Attributes} interface, it does
 * not support Namespace-related information.
 * </p>
 * 
 * <p>
 * When an attribute list is supplied as part of a
 * {@link org.xml.sax.DocumentHandler#startElement startElement} event, the list
 * will return valid results only during the scope of the event; once the event
 * handler returns control to the parser, the attribute list is invalid. To save
 * a persistent copy of the attribute list, use the SAX1
 * {@link org.xml.sax.helpers.AttributeListImpl AttributeListImpl} helper class.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * (Note that the result of getLength() will be zero if there are no
 * attributes.)
 * 
 * <p>
 ...
 *             {@link org.xml.sax.Attributes Attributes} interface, which
...
public interface AttributeList
{
	 ...
	 * without a value specified in the start tag) will be omitted from the
	 * list.
	 * </p>
	 * 
	 * <p>
	 ...
	 * NMTOKENS), the tokens will be concatenated into a single string separated
	 * by whitespace.
	 * </p>
	 * 
	 * @param i
	 ...
	 * 
	 * <p>
	 * If the attribute name has a namespace prefix in the document, the
