 ...
 * SAX2 by {@link org.xml.sax.XMLReader XMLReader}, which includes Namespace
 * support and sophisticated configurability and extensibility.
 * </p>
 * 
 * <p>
 * All SAX1 parsers must implement this basic interface: it allows applications
 * to register handlers for different types of events and to initiate a parse
 * from a URI, or a character stream.
 * </p>
 * 
 * <p>
 * All SAX1 parsers must also implement a zero-argument constructor (though
 ...
 *             {@link org.xml.sax.XMLReader XMLReader} interface, which includes
 *             Namespace support.
 * @since SAX 1.0
