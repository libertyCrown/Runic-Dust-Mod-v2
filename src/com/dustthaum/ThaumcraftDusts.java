...
@Mod(modid = "ThaumDusts", name= "Runic Dust Mod- Thaumcraft Compat", version="v2.0", dependencies = "required-after:DustModCore;required-after:Thaumcraft")
...
public class ThaumcraftDusts
{
	...
	{
		DustItemManager.registerDust(388, "Thaumium", "ThaumDust", 
