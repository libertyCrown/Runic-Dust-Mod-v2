 ...
 */
public class RuneBarrier extends DustEvent
{
		...
		if (e.ticksExisted % ticksperblock == 0)
		{
			...
			for (int t = -height; t <= height + 1; t++)
			{
				for (int w = -width; w <= width; w++)
				{
					...
					int b = world.getBlockId(x + (dir ? w : 0), y - t
							+ currentHeight, z + (dir ? 0 : w));
					int m = world.getBlockId(x + (dir ? w : 0), y - t
							+ currentHeight, z + (dir ? 0 : w));
					int nb = world.getBlockId(x + (dir ? w : 0), y - t
							+ currentHeight + 1, z + (dir ? 0 : w));
					...
					world.setBlock(x + (dir ? w : 0),
							y - t + currentHeight + 1, z + (dir ? 0 : w), b, m,
							3);
					world.setBlock(x + (dir ? w : 0), y - t + currentHeight, z
							+ (dir ? 0 : w), /*
											 * (t == height+1) ?
											 * Block.brick.blockID:
											 */0, 0, 3);
