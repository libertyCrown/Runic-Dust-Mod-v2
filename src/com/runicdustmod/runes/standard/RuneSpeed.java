 ...
 */
public class RuneSpeed extends DustEvent
{
	public RuneSpeed()
	{
		super();
	...
	{
		ItemStack[] req = new ItemStack[] { new ItemStack(Item.sugar, 3, -1),
		...
		for (Entity i : ents)
		{
			...
			{
				((EntityLivingBase) i).addPotionEffect(new PotionEffect(
						Potion.moveSpeed.id, d, p));
			}
		}
