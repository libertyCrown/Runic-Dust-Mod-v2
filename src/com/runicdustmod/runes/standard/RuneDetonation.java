 ...
 */
public class RuneDetonation extends DustEvent
{
	public RuneDetonation()
	{
		super();
	}
	...
	{
		e.worldObj.createExplosion(e, e.posX, e.posY - EntityDust.yOffset,
				e.posZ, (float) (level * level) / 10000 + 2F, true);
	}
}
