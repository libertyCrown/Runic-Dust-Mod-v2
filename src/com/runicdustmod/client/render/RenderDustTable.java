...
import com.runicdustmod.client.model.ModelDustBook;
...
public class RenderDustTable extends TileEntitySpecialRenderer
{
	private ResourceLocation texture = new ResourceLocation(References.path
			+ "/pages/info.png");
	private ResourceLocation texture1 = new ResourceLocation(References.path
			+ "/book.png");
	...
	public void render(TileEntityDustTable tedt, double d, double d1,
			double d2, float f)
	{
		float f4 = tedt.prevPageFlipping
				+ (tedt.pageFlipping - tedt.prevPageFlipping) * f + 0.25F;
		float f5 = tedt.prevPageFlipping
				+ (tedt.pageFlipping - tedt.prevPageFlipping) * f + 0.75F;
