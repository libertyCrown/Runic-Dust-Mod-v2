...
public class ItemInk extends DustModItem
{
	...
	public String getUnlocalizedName(ItemStack itemstack)
	{
		...
		if (id != null)
			return "tile.ink." + DustItemManager.idsRemote[dustID];
		return "tile.ink";
	}
	...
	public int getColorFromItemStack(ItemStack stack, int pass)
	{
		...
		if (pass == 0)
			return 16777215;
		return pass == 1 ? DustItemManager.getPrimaryColor(id)
				: DustItemManager.getSecondaryColor(id);
	}
	...
	{
		return new ItemStack(DustContent.ink.itemID, 1, dustID * maxAmount
				+ maxAmount - 1);
	}
	...
	{
		this.bottle = iconRegister.registerIcon(References.spritePath
				+ "inkBottle");
		main = new Icon[8];
		sub = new Icon[8];
		for (int i = 0; i < main.length; i++)
		{
			main[i] = iconRegister.registerIcon(References.spritePath
					+ "ink_main_" + i);
			sub[i] = iconRegister.registerIcon(References.spritePath
					+ "ink_sub_" + i);
		}
	}
