...
public class DustBlockRenderers implements ISimpleBlockRenderingHandler
{
	...
	// */
	// public void renderEastFace(RenderBlocks rb, int height, Block par1Block,
	// double par2, double par4, double par6, Icon par8)
	// {
	...
	// double var14 = ((double)var10 + rb.renderMaxX * (double)16 - 0.01D) /
	// 256.0D;
	// double var16 = ((double)(var11 + 16) - rb.renderMaxY * (double)height) /
	// 256.0D;
	// double var18 = ((double)(var11 + 16) - rb.renderMinY * (double)16 -
	// 0.01D) / 256.0D;
	// double var20;
	//
	// if (rb.flipTexture)
	...
	// var14 = ((double)(var10 + 16) - rb.renderMaxX * (double)height - 0.01D) /
	// 256.0D;
	// var16 = ((double)var11 + rb.renderMaxY * (double)height) / 256.0D;
	// var18 = ((double)var11 + rb.renderMinY * (double)height - 0.01D) /
	// 256.0D;
	// var20 = var14;
	// var22 = var12;
	// var24 = var16;
	...
	// if (rb.enableAO)
	// {
	// var9.setColorOpaque_F(rb.colorRedTopLeft, rb.colorGreenTopLeft,
	// rb.colorBlueTopLeft);
	// var9.setBrightness(rb.brightnessTopLeft);
	// var9.addVertexWithUV(var28, var34, var36, var20, var24);
	// var9.setColorOpaque_F(rb.colorRedBottomLeft, rb.colorGreenBottomLeft,
	// rb.colorBlueBottomLeft);
	// var9.setBrightness(rb.brightnessBottomLeft);
	// var9.addVertexWithUV(var30, var34, var36, var12, var16);
	// var9.setColorOpaque_F(rb.colorRedBottomRight, rb.colorGreenBottomRight,
	// rb.colorBlueBottomRight);
	// var9.setBrightness(rb.brightnessBottomRight);
	// var9.addVertexWithUV(var30, var32, var36, var22, var26);
	// var9.setColorOpaque_F(rb.colorRedTopRight, rb.colorGreenTopRight,
	// rb.colorBlueTopRight);
	...
	// Args: block, x, y, z, texture
	// */
	// public void renderWestFace(RenderBlocks rb, int height, Block par1Block,
	// double par2, double par4, double par6, int par8)
	// {
	// Tessellator var9 = Tessellator.instance;
	//
	...
	// Args: block, x, y, z, texture
	// */
	// public void renderNorthFace(RenderBlocks rb, int height, Block par1Block,
	// double par2, double par4, double par6, int par8)
	// {
	// Tessellator var9 = Tessellator.instance;
	//
	...
	// double var14 = ((double)var10 + rb.renderMaxZ * (double)16 - 0.01D) /
	// 256.0D;
	// double var16 = ((double)(var11 + 16) - rb.renderMaxY * (double)height) /
	// 256.0D;
	// double var18 = ((double)(var11 + 16) - rb.renderMinY * (double)16 -
	...
	// var14 = ((double)(var10 + 16) - rb.renderMaxZ * (double)height - 0.01D) /
	// 256.0D;
	// var16 = ((double)var11 + rb.renderMaxY * (double)height) / 256.0D;
	// var18 = ((double)var11 + rb.renderMinY * (double)height - 0.01D) /
	// 256.0D;
	...
	// Args: block, x, y, z, texture
	// */
	// public void renderSouthFace(RenderBlocks rb, int height, Block par1Block,
	// double par2, double par4, double par6, int par8)
	// {
	// Tessellator var9 = Tessellator.instance;
	//
