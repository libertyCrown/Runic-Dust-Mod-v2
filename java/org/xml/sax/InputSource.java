 ...
 * InputSource or else (if no encoding is specified) autodetecting the character
 * encoding using an algorithm such as the one in the XML specification. If
 ...
 * end-of-parse cleanup, so applications should not attempt to re-use such
...
public class InputSource
{
	...
	/**
	 * Get the character encoding for a byte stream or URI. This value will be
	 * ignored when the application provides a character stream.
	 * 
