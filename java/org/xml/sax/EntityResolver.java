 ...
 * SAX driver using the {@link org.xml.sax.XMLReader#setEntityResolver
 ...
 * be especially useful for applications that build XML documents from databases
 * or other specialised input sources, or for applications that use URI types
 * other than URLs.
 * </p>
 * 
 * <p>
 * The following resolver would provide the application with a special character
 * stream for the entity with the system identifier
