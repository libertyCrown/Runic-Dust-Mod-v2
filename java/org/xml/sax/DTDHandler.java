 ...
 * recommendation <em>requires</em> processors to report: notation and unparsed
 * entity declarations.
 * </p>
 * 
 * <p>
 ...
 * {@link org.xml.sax.ext.LexicalHandler LexicalHandler} is used, these events
 * must also be reported before the endDTD event.)
 * </p>
 * 
 * <p>
 * It is up to the application to store the information for future use (perhaps
 * in a hash table or object tree). If the application encounters attributes of
 * type "NOTATION", "ENTITY", or "ENTITIES", it can use the information that it
...
public interface DTDHandler
{
	 ...
	 * record the entity for later reference, if necessary; unparsed entities
