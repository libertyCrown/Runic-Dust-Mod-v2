...
public class EntityAIDustFollowBaitRune extends EntityAIBase
{
	...
	public EntityAIDustFollowBaitRune(EntityCreature par1EntityCreature,
			float speed)
	{
	...
	public boolean shouldExecute()
	{
		...
		return false;
		// if (targetEntity.getDistanceSqToEntity(theEntity) >
		// (double)(field_48331_g * field_48331_g))
		// {
		// return false;
		// }
		//
	...
	public void updateTask()
	{
		...
		if (Math.random() < 0.2)
		{
			RunicDustMod.spawnParticles(theEntity.worldObj, "smoke", theEntity.posX,
