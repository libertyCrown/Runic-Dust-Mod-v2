 ...
 */
public class RuneFarm extends DustEvent
{
	public RuneFarm()
	{
		super();
	...
	public void onTick(EntityDust e)
	{
		...
		if (e.ticksExisted == 0)
		{
				...
				for (int dk = -r; dk <= r; dk++)
				{
					...
					for (int dj = r; dj >= -r; dj--)
					{
						...
						if ((bidb == Block.dirt.blockID
								...
								&& (bidt == 0 || RunicDustMod.isDust(bidt) || bidt == Block.tallGrass.blockID))
						{
							...
							world.setBlock(i + di, j + dj, k + dk, 0, 0, 3);
							world.setBlock(i + di, j + dj, k + dk,
									Block.crops.blockID, meta, 3);
							locs.add(i + di + 0.5);
			...
			RunicDustMod.spawnParticles(e.worldObj, "smoke", locations, 0, 0, 0, 8,
                    0.5, 0.2, 0.5);
		}
		e.fade();
	}
